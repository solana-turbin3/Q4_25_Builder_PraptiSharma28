...
export type SubmitTsInstruction<
  ...
  TAccountCollection extends
    | string
    | AccountMeta<string> = '5ebsp5RChCGK7ssRZMVMufgVZhd2kFbNaotcZ5UvytN2',
...
> {
  ...
  if (!accounts.collection.value) {
    accounts.collection.value =
      '5ebsp5RChCGK7ssRZMVMufgVZhd2kFbNaotcZ5UvytN2' as Address<'5ebsp5RChCGK7ssRZMVMufgVZhd2kFbNaotcZ5UvytN2'>;
  }
